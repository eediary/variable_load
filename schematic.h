...
#define SCH_SPI_BIT_ORDER (HAL_SPI::SPI_MSB_FIRST)
#define SCH_SPI_SS_DIR (HAL_SPI::SPI_OUTPUT)
...
#define SCH_MAX5216_PD_MODE (MAX5216::OUT_GND_1K)
...
#define SCH_UI_BTN_PIN (HAL_GPIO::GPIO_PIN6)

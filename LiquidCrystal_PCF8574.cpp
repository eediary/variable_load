...
LiquidCrystal_PCF8574::LiquidCrystal_PCF8574(PCF8574::PCF8574_ADDRESS TWI_addr):
	TWI(HAL_TWI()),
	GPIO_Exp(TWI, TWI_addr)
{
  _backlight = 0;
...
void LiquidCrystal_PCF8574::print(char *str){
...
inline void LiquidCrystal_PCF8574::write(uint8_t value) {
...
void LiquidCrystal_PCF8574::_sendNibble(uint8_t halfByte, uint8_t mode) {
  // delays aren't necessary since each I2C transfer takes at least 180 us
...
void LiquidCrystal_PCF8574::_write2Wire(uint8_t halfByte, uint8_t mode, uint8_t enable) {
  ...
  // Send data to GPIO expander
  GPIO_Exp.write(i2cData);
} // write2Wire
